...
// DuePi -> Atmel SAM3X8E ARM Cortex-M3
#define DuePi
...
#define ReceiverIBUS        // FlySky serial 115200 (2 byte header (0x20 0x40), N. channels x 2 bytes, 2 byte checksum (0xFF 0xFF))
//#define RECEIVER_DUE      // Use a PPM receiver Arduino Due
...
//#define MavLink               // Enables the MavLink protocol, OFF serial
