...
void applyMotorCommand() {
    ...
    motorAxisCommandYaw = (YAW_DIRECTION * motorAxisCommandYaw)
  #endif
  motorCommand[FRONT_LEFT]  = throttle - motorAxisCommandPitch + motorAxisCommandRoll - motorAxisCommandYaw;
  motorCommand[FRONT_RIGHT] = throttle - motorAxisCommandPitch - motorAxisCommandRoll + motorAxisCommandYaw;
  motorCommand[REAR_LEFT]   = throttle + motorAxisCommandPitch + motorAxisCommandRoll + motorAxisCommandYaw;
  motorCommand[REAR_RIGHT]  = throttle + motorAxisCommandPitch - motorAxisCommandRoll - motorAxisCommandYaw;
